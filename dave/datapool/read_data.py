...
def read_ehv_data():
    ...
    if all(
        ...
        # get data from datapool
        # read data
        ehv_data = HDFStore(get_data_path("ehv_data.h5", "data"))
    ...
    # read meta data
    meta_data = read_excel(get_data_path("ehv_data_meta.xlsx", "data"), sheet_name=None)
...
def read_hp_data():
    ...
    """
    # --- read data
    hp_data = HDFStore(get_data_path("hp_data.h5", "data"))
    data_crs = "EPSG:31468"
    # nodes
    ...
    # read meta data
    meta_data = read_excel(get_data_path("hp_data_meta.xlsx", "data"), sheet_name=None)
...
def read_gas_storage_ugs():
    ...
    if all(
        ...
        # --- read data
        storage_data = HDFStore(get_data_path("gas_storage_ugs.h5", "data"))
        # cavern storage for crude oil, petroleum products and liquid gas
    ...
    # read meta data
    meta_data = read_excel(get_data_path("gas_storage_ugs_meta.xlsx", "data"), sheet_name=None)
...
def read_scigridgas_igginl():
    ...
    if all(
        ...
        # --- get data from datapool
        # read data
        igginl_data = HDFStore(get_data_path("scigridgas_igginl.h5", "data"))
        # border_points
    ...
    # read meta data
    meta_data = read_excel(get_data_path("scigridgas_igginl_meta.xlsx", "data"), sheet_name=None)
    return storage_data, meta_data
