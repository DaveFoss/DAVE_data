...
def line_connections(grid_data):
    ...
    nearest_building_point = gpd.GeoSeries(grid_data.lv_data.lv_nodes[grid_data.lv_data.lv_nodes.node_type == 'nearest_point'].geometry)
            ...
            if not road_junctions_grid.empty:
                ...
                if distance.min() < 1E-04:
                    ...
                    if distance.min() < 1E-04:
                        ...
                        grid_data.lv_data.lv_nodes = grid_data.lv_data.lv_nodes.append(gpd.GeoDataFrame({'geometry': [road_junction_geom],
                                                                                                         'dave_name': dave_name,
